...
public class HotelTest_old {
    ...
    public void testCheckInWithWrongPassword() {
        Room2 room = hotel.checkIn(wrongPassword, GUEST_NAME_1);
    ...
    public void testCheckInWithCorrectPassword() {
        Room2 room1 = hotel.checkIn(correctPassword, GUEST_NAME_1);
        assertEquals("Correct 1st guest check in", GUEST_NAME_1, room1.getGuest().getName());

        Room2 room2 = hotel.checkIn(correctPassword, GUEST_NAME_2);
        assertEquals("Correct 2nd guest check in", GUEST_NAME_2, room2.getGuest().getName());

        Room2 noRoom = hotel.checkIn(correctPassword, GUEST_NAME_3);
    ...
    public void testCheckoutOccupiedRoom() {
        Room2 room = hotel.checkIn(correctPassword, GUEST_NAME_1);
    ...
    public void testGetFreeRoomFromFullHotel() {
        ...
        Room2 noRoom = hotel.getFreeRoom();
    ...
    public void testGetRoomBeforeCheckIn() {
        Room2 room = hotel.getRoom(GUEST_NAME_1);
